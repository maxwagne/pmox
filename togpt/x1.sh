...
case "$ACTION" in
    -on)
        ...
        echo "usb0: host=3-1" >> "$VM_CONF"
        echo "usb1: host=3-2" >> "$VM_CONF"
	echo "usb2: host=3-3" >> "$VM_CONF"
	echo "usb3: host=3-4" >> "$VM_CONF"
	echo "usb3: host=5-1" >> "$VM_CONF"
	echo "usb3: host=5-2" >> "$VM_CONF"
	echo "usb3: host=5-3" >> "$VM_CONF"
	echo "usb4: host=5-4" >> "$VM_CONF"
